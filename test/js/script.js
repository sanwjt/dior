...
function scrollBegin(){
    ...
    // 全部动画
       ...
       if(11743 < scrollPro && scrollPro < 12335){
        ...
        if(19167< scrollPro && scrollPro < 19858){
            huabanyu.x = scrollNum(19167,19858,scrollPro,460,680);
            huabanyu.y = scrollNum(19167,19858,scrollPro,0,200);
            // huabanyu.alpha = scrollNum(19167,19681,scrollPro,0,0);
          }
